...
function Game({
  ...
  return (
    ...
    <div className="text-white flex sm:flex-col lg:flex-row place-content-between p-10 mx-24 items-center space-x-10">
      ...
      <div className="bg-radial from-neutral-700 to-neutral-800 p-8 grow text-center rounded-3xl grid grid-cols-2 grid-rows-2 gap-6 shadow-stone-900 shadow-xl max-w-xl">
        <h1 className="text-8xl font-bold col-span-2 mb-0 leading-[1.3] slashed-zero">
          {color}
        </h1>
        <div
          className="w-full h-full rounded-lg row-span-2"
